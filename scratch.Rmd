...
The following dbplyr code is expected to take 18.5 hours:
...
for(i in 1:100){
  ...
  result[[i]] <- 
    ...
    collect() %>%
    slice_sample(n = num_sample) # This has to come after collect b/c it isn't implemented in dbplyr (yet?). Maybe do with SQL code.
    #slice_sample(n = 100)
  #print(i)
}
toc()
...
Maybe try writing my own sql so that sampling is done in the database? Didn't quite get the following to work.S
