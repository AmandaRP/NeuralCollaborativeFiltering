...
2. GoodReads book recommendations: See the `goodreads.R` script in this repo. A Christian book subset is provided in the `/Data` directory. To create your own genre subset, use the `/Data/genre_subset.R` script.
